...
//         View.CanUseTemporaryVisibilityModes() instead of a hand-maintained list of ViewType enum
//         values — more correct, since it asks Revit directly rather than guessing which view
//         types support isolation.
// ============================================================
