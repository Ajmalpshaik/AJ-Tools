// AJ Connect tool: Unhide All
//
// Runs inside AJ Connect via Roslyn. Available by name: Document, UIDocument, Application,
...
using (var transaction = new Transaction(Document, "AJ Connect: Unhide All"))
{
    transaction.Start();
