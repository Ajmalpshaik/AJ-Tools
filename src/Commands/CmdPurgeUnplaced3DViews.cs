 ...
 * File Name     : CmdPurgeUnplaced3DViews.cs
 * Purpose       : Entry command that previews unplaced 3D views (not on any sheet) and deletes the ones
 ...
 *
 * Input         : Full Project - unplaced 3D views; the user selects which to delete in the window.
 * Output        : Selected views deleted in one transaction; final report from the window.
 *
 * Notes         :
