...
namespace AJTools.Services.SmartConnect
{
    ...
    internal sealed class SmartConnectRouteBuilder
    {
        ...
        private static readonly double MinSegmentLength = UnitUtils.ConvertToInternalUnits(10.0, DisplayUnitType.DUT_MILLIMETERS);
        private static readonly double MinRunLength = UnitUtils.ConvertToInternalUnits(50.0, DisplayUnitType.DUT_MILLIMETERS);
        ...
        {
            return value == null || value == ElementId.InvalidElementId || value.IntegerValue <= 0;
        }
