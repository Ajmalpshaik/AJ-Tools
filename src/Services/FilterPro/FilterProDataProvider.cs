 ...
 * - ParameterFilterUtilities.GetFilterableParametersInCommon verified unchanged across Revit
 *   2020-2027 against the per-version RevitAPI reference assemblies (2026-07-23).
 * - LabelUtils.GetLabelFor(BuiltInParameter) used for built-in parameter display names — verified
 *   present on 2020-2027 (only the legacy enum overloads, e.g. ParameterType/DisplayUnitType,
 *   were removed in later versions; this overload is unaffected).
